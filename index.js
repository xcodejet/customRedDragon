const {
  ...
  const webserver = express()
   ...
   .listen(2006, () => console.log(`EveloCore eveocode hosting on ${2006}`))
      ...
      try {
        ...
        for (let num of participants) {
          ...
          if (anu.action == 'add') {
            ...
            //if (!ec.welcomestate) return
            EveloCodeRD.sendMessage(anu.id, {
              text: `*Hi,* ${xeonName.split("@")[0]}\n*Welcome to Tereance Auto Service Whatsapp Group.* 🤗\n\n*Tereance Auto Service Whatsapp සමූහය වෙත සාදරයෙන් පිළිගනිමු.🤗*`
            })
